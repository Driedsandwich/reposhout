...
- **文字数の数え方を近似ではなく twitter-text v3 の定義どおりにしている。** 既定の重みは2で、重み1は4つの範囲だけ。絵文字は書記素クラスタ1つで2、URLは長さによらず23、先にNFC正規化します。近似は両方向に外れます——以前の版は半角カタカナや矢印を1と数えて**Xが受け付けない長さの投稿を作りうる**状態でしたし、ZWJの家族絵文字を2ではなく11と数えていました
