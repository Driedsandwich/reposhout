...
(function (root) {
  ...
  var URLS = [
    ...
    ['compareは下書き本文を共有しない（自由文・R12-001）', 'https://github.com/o/r/compare/main...feature?quick_pull=1&title=Fix&body=Why&labels=bug', 'https://github.com/o/r/compare/main...feature?quick_pull=1&labels=bug'],
