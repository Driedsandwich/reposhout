...
(function (root) {
  ...
  var URLS = [
    ...
    ['Issue一覧の検索語は共有しない（自由文・R12-001）', 'https://github.com/o/r/issues?q=is%3Aopen+label%3Abug', 'https://github.com/o/r/issues'],
    ['Issue一覧の state も残す', 'https://github.com/o/r/issues?state=open', 'https://github.com/o/r/issues?state=open'],
    ['PR一覧はページだけ残し、検索語は落とす', 'https://github.com/o/r/pulls?q=is%3Apr&page=2', 'https://github.com/o/r/pulls?page=2'],
    ['知らないクエリも自由文も落とす', 'https://github.com/o/r/issues?q=is%3Aopen&unknown=1&state=open', 'https://github.com/o/r/issues?state=open'],
    ...
    ['compareは下書き本文もラベルも共有しない（R12-001・R13-001）', 'https://github.com/o/r/compare/main...feature?quick_pull=1&title=Fix&body=Why&labels=bug', 'https://github.com/o/r/compare/main...feature?quick_pull=1'],
    ['PRのdiff表示指定を残す', 'https://github.com/o/r/pull/12/files?diff=split&w=1', 'https://github.com/o/r/pull/12/files?diff=split&w=1'],
    ['commitsのauthorも共有しない（値の集合を数えられない・R13-001）', 'https://github.com/o/r/commits/main?author=octocat', 'https://github.com/o/r/commits/main'],
    ['Actionsの検索語は共有しない（自由文・R12-001）', 'https://github.com/o/r/actions?query=branch%3Amain&page=2', 'https://github.com/o/r/actions?page=2'],
    ['GitHub検索は種別だけ残し、検索語は落とす', 'https://github.com/search?q=chrome+extension&type=repositories', 'https://github.com/search?type=repositories'],
    ['ユーザーページのtabは残す', 'https://github.com/octocat?tab=repositories', 'https://github.com/octocat?tab=repositories'],
    ['設定ページは共有しない', 'https://github.com/settings/tokens?token=ghp_example', null],
    ['OAuth認可URLは共有しない', 'https://github.com/login/oauth/authorize?client_id=abc&state=xyz', null],
    ['リポジトリ設定も共有しない', 'https://github.com/o/r/settings/keys?x=1', null],
    ['資格情報の形のハッシュは落とす', 'https://github.com/o/r/issues/12#access_token=abc', 'https://github.com/o/r/issues/12'],
    ['機微な名前のパラメータは落とす', 'https://github.com/o/r/issues?state=open&session_token=zzz', 'https://github.com/o/r/issues?state=open'],
    ['httpは共有しない（github.com の https だけ）', 'http://github.com/o/r?x=1', null],
    ['github以外は共有しない', 'https://example.com/a?b=1#c', null],
    ['URLとして壊れているものは共有しない', 'not a url?x=1#y', null],
