...
> **⚠️ これはマージ前に書いた記録です。** 下の「作業時点の状態」はその時点の事実で、
> いまの状態ではありません（1.1.4 はその後 main へマージし、タグも打ちました）。
> **公開状態の正本は [RELEASE_STATUS.md](RELEASE_STATUS.md) です。**

---

## 1. 作業時点の状態（2026-08-06・マージ前）

| 項目 | 状態 |
|---|---|
| main | `4db83f0`（1.1.3） |
| 1.1.4 | この記録を書いた時点では作業ツリーのみ（→ その後 main `0be7aaf`・タグ `v1.1.4`） |
