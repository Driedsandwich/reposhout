# Chrome ウェブストア掲載欄の差分（1.0.1 → 1.1.1）

作成: 2026-08-05 / 対象: 掲載中の 1.0.1 を 1.1.1 へ更新するときに、ダッシュボードのどの欄を何に直すか。
...
`npm run package` で作れます。同じ内容なら何度作っても同じZIPになるので、`dist/reposhout-1.1.1.zip.sha256` の値を控えておけば、提出したものと手元のものが同じかを後から確かめられます。
...
- 掲載中 1.0.1 の説明文の即時修正（1.1.1 の提出と同時で足りるか、先に文面だけ直すかは本人の判断）
